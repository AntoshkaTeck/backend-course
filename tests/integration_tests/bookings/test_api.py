...
@pytest.mark.parametrize(
    ...
    [
        (1, "2025-11-01", "2025-11-30", 422),
        (1, "2025-12-01", "2025-12-30", 200),
        (1, "2025-12-01", "2025-12-30", 200),
        (1, "2025-12-01", "2025-12-30", 200),
        (1, "2025-12-01", "2025-12-30", 200),
        (1, "2025-12-01", "2025-12-30", 200),
        (1, "2025-12-01", "2025-12-30", 409),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (1, "2025-12-01", "2025-12-05", 1),
        (1, "2025-12-10", "2025-12-20", 2),
        (1, "2026-01-01", "2026-01-10", 3),
    ],
)
